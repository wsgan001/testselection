...
testing, we fist develop a regression-test-selection approach, which selects every test case that may reveal a fault caused by policy changes. 
...
However, existing test cases may not cover all of rules in policies impacted by policy changes.
To address this issue, we develop a test augmentation technique by generating additional test cases 
