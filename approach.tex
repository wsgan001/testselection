...
We analyze given program code and polices to select \emph{only} test cases for regression testing in case of policy evolution. 
...
%test cases which are correlated with changed rules.
\textbf{Test Selection.}
Once the mapping test-rule is established, we proceed test select step described in the first approach by 
