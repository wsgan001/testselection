...
While \CodeIn{M-Sub}, \CodeIn{M-Cond}, and \CodeIn{M-SubCond} require to modify existing test cases, \CodeIn{M-Others} requires to create new test cases issuing requests
