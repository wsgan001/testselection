...
Virtual Meeting System (\CodeIn{VMS}) provides for web conference services to organize online meetings.
...
%Within each column group, we show the subject names,
%the lines of code, and the numbers of system test cases and security test cases as well as policy coverage.
%Columns 5-7 show the numbers of covered rules with test cases, not-covered rules with test cases, and the percentage
...
The largest one is \CodeIn{ASMS}, which consists of 129 rules.
...
We notice that \CodeIn{VMS} often shows the highest test reduction compared \CodeIn{LMS} and \CodeIn{ASMS}.
