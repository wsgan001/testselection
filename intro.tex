...
Access control is one of the privacy and security mechanisms that authorizes legitimate users to access or share critical information. 
...
Our approach detects policy rules, which map such requests. These rules are dangerous portions to be validated. 
